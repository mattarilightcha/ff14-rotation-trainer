...
**読まないファイル:** `UISAVE.DAT`（他のプレイヤーの名前などが入っているため。[CONFIG_FORMAT.md §3.1](./CONFIG_FORMAT.md#31-個人情報についての注意重要)）、マクロ、チャットのログ、ギアセット、フレンドリストなど、練習に関係ないファイルは読まない。アプリは上の表のファイル名だけを受け付け、それ以外は選ばれても無視する。
